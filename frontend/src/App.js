    ...
    <Router>
      <Switch>
        ...
        <Route exact={true} path="/create-application">
          <Navbar component={<CreateApplication/>} title="Create Application"/>
        </Route>
        ...
        <Route path="/reset-password/:token" component={
          ({match}) => {
            return <Navbar component={<ResetPassword match={match}/>} title="Reset Password"/>;
          }
        }/>
        ...
        <Route path="/application/:appid" component={
          ({match}) => {
            return <Navbar component={<Application match={match}/>} title="Viewing Application"/>;
          }
        }/>
