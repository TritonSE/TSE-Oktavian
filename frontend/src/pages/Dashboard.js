...
import { Card, CardContent, Grid, Snackbar, LinearProgress, Typography } from '@material-ui/core';
      ...
      fetch(`${BACKEND_URL}/api/stats`, {
        ...
        response.json().then((json) => {
          if (response.ok) {
            ...
            setState({...state, loading: false, snack: {message: `Could not load stats: ${json.message}`, open: true}});
          }
        }).catch((error) => {
